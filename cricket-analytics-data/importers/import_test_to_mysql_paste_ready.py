...
#
# IMPORT_LIMIT = 10
#     Import first 10 Test matches chronologically.
#
# IMPORT_LIMIT = None
...
def validate_csv_data(data):
    ...
    for row in data["matches"]:
        ...
        if text(row["match_type"]) != "Test":
            fail(
                "Non-Test record found:\n"
                f"{row['match_id']} / "
                f"{row['match_type']}"
            )
...
def prepare_competition(
    ...
    if not competition:
        ...
        fail(
            "International Test competition "
...
def insert_matches(
    ...
    try:
        ...
        for row in data["matches"]:
            ...
            # Test matches are not a league tournament stage.
            stage = "Test"
...
def run_import(
    ...
    if IMPORT_LIMIT is None:
        ...
        print()
        print("Player career statistics: SKIPPED during pilot import")
